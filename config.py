...
# счета, по которым в свод попадут без субсчетов и аналитики
...
Также необходимо, чтобы анализ счета был расшифрован как минимум по субсчетам или субконто, иначе 1С не будет сформирован столбец "Счет", без которого скрипт отработает неверно. Требование обязательности расшифровки корреспондирующих счетов нет, допускается по субсчетам и субконто первого уровня (не глубже).
